...
namespace OsuHook.Patches.ShowComboBreaks
{
    internal static class ShowComboBreaksUtil
    {
        ...
        {
            FSliderOsu_sliderTicksHitStatus = SliderOsu.Class.GetRuntimeFields()
        ...
        {
            if (SliderOsu.Class.IsInstanceOfType(hitObject))
            {
            ...
            return SliderOsu.Class.IsInstanceOfType(hitObject)
